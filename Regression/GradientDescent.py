...
class GradientDescent:
	def __init__(self, dataset, learningRate, tolerance):
	...
	def validate(self):
		...
		print("PLOTTED FOLD :: {}".format(plotFold))
		...
		for train_index, test_index in KFold(n_splits=10, shuffle=True).split(self.dataset):
			...
			w = self.gradientDescent(trainDataset, fold == plotFold)
